export const base = {
  ...
  findOrCreateDoc: "Paste weblink, or search to link to a page",
  createChildCard: "Create subpage",
  ...
  searchOrPasteLink: "Paste weblink or search to link a page",
